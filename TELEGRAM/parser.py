...
import schedule #Библиотека времени.
...
def pars():
    ...
    path ='C:/Users/aleks/Desktop/РАБОЧЕЕ РАСПИСАНИЕ  2022-2023/Новая папка' # Путь к вашей папке
    ...
    # КОНЕЦ ПРОВЕРКИ ФАЙЛА
        ...
        # Создаем для каждого файла переменную, в которую будет записывать результат вывода.
        #Прописываем путь сохранения результата в текстовый файл
        ...
        #Происходит открытие файл с дальнейшем его изменением
...
def main():
    schedule.every(4).seconds.do(pars) #Выполнение функции каждую субботу в 14:00
    while True:
